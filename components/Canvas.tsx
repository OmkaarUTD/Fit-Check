...
import { RotateCcwIcon, ChevronLeftIcon, ChevronRightIcon, DownloadIcon, UndoIcon, RedoIcon } from './icons';
    ...
    <div className="w-full h-full flex items-center justify-center p-4 relative animate-zoom-in group">
      ...
      <div className="absolute top-4 left-4 z-30 flex items-center gap-2">
        <div className="flex items-center bg-white/60 border border-gray-300/80 rounded-full backdrop-blur-sm shadow-sm">
          <button 
              onClick={onStartOver}
              className="flex items-center justify-center text-center text-gray-700 font-semibold py-2 pl-4 pr-3 rounded-l-full transition-colors duration-200 ease-in-out hover:bg-white/80 active:scale-95 text-sm"
          ...
          <button
            ...
            className="p-2 text-gray-700 hover:bg-white/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            aria-label="Undo"
          >
          ...
          <button
            ...
            className="p-2 text-gray-700 hover:bg-white/80 transition-colors rounded-r-full disabled:opacity-50 disabled:cursor-not-allowed"
            aria-label="Redo"
          >
